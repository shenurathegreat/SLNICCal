...
st.write("Enter your full name and National Identity Card (NIC) number below.warning!!!Your details will not be saved in any forms in any servers.Created by Shenura Fernando.ALL rights reserved!")
